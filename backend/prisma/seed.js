...
async function main() {
    ...
    // 3. SUPER ADMIN USER
    // ============================================================================
    const superAdminPassword = await bcryptjs_1.default.hash('Admin@123', 12);
    ...
    const tenant1AdminPassword = await bcryptjs_1.default.hash('Tech@123', 12);
    ...
    const tenant1Op1Password = await bcryptjs_1.default.hash('Operador@123', 12);
    ...
    const tenant2AdminPassword = await bcryptjs_1.default.hash('Fitness@123', 12);
    ...
    const tenant3AdminPassword = await bcryptjs_1.default.hash('Clinica@123', 12);
    ...
    const whatsappInstance1 = await prisma.whatsappInstance.create({
        data: {
            ...
            apiKeyEncrypted: 'evo_key_' + (0, uuid_1.v4)().substring(0, 8),
